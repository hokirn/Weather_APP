...
import com.dong.dongweather.AddCountyActivity;
import com.dong.dongweather.BaiduLocation;
import com.dong.dongweather.HourlyWeather;
import com.dong.dongweather.HourlyWeatherAdapter;
...
public class WeatherActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    //通过申请和风天气api获取的key
    public static final String KEY = "fd8fe310bb6f4b03a725a8b2164ef7f1";
    ...
    public void initView() {
        ...
        //restrict: 控制循环次数，防止百度定位时间过长影响程序的使用
        int restrict = 0;
        while (true) {
            ...
            if (null != locationCountyWeatherId && null != locationCountyWeatherName) {
                ...
                if (restrict > 10000) {
                    Toast.makeText(this, "加载失败，已默认定位到海淀", Toast.LENGTH_SHORT).show();

                    SelectedCounty selectedCounty = new SelectedCounty();
                    selectedCounty.setWeatherId("CN101010200");
                    selectedCounty.setCountyName("海淀");
                    selectedCountisList.add(0, selectedCounty);
                    LayoutInflater layoutInflater = getLayoutInflater();
                    viewList.add(viewList.size(), (View) layoutInflater.inflate(R.layout.weather_fragment, null));
                    isAddLocationView = true;
